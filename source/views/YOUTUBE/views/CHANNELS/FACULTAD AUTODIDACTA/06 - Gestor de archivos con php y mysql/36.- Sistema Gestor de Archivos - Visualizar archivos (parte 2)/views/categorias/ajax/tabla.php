    ...
    <table class="table table-hover table-dark" id="tablaCategoriasDataTable">
        ...
        ?>
            <tr>
                ...
                <td>
                    <span class="btn btn-warning btn-sm" style="text-align:center;" data-toggle="modal" data-target="#modalActualizarCategoria" onclick="obtenerDatosCategoria('<?php echo $idCategoria; ?>')">
                        <span class="fas fa-edit"></span>
                    </span>
                </td>
                <td>
                    <span class="btn btn-danger btn-sm" style="text-align:center;" onclick="eliminarCategorias('<?php echo $idCategoria; ?>')">
